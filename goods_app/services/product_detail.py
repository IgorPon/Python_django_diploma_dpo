...
class CurrentProduct:
    ...
    def get_calculate_prices(self) -> Dict:
        ...
        if all_sellers:
            ...
            return {"best_offer": False, "avg_price": "", "avg_price_after_discount": "not determine"}
        ...
        try:
            ...
            return {"best_offer": False, "avg_price": avg_price, "avg_price_after_discount": avg_price_after_discount}
        return {
